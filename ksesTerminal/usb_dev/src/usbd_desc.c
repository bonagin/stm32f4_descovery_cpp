...
#define USBD_PRODUCT_STRING          "KSES VCP"

#define USBD_SERIALNUMBER_STRING     "serialHERE"

#define USBD_CONFIGURATION_STRING    "usb-cdc config"
#define USBD_INTERFACE_STRING        "usb-cdc Interface"
